...
saved_df = pd.read_csv(
    r"D:\\p1 html\\Attendance-System-Project-main\\5. Encodings\\encodings.csv")
...
path = "Attendance-System-Project-main\\6. Attendence\\With_Camera\\"
...
with st.expander("Create New Attendence Sheet"):
    ...
    if st.button("Create New Attendence Sheet"):
        ...
        name_of_attendence_sheet = name_of_attendence_sheet
        df.to_csv("D:\\p1 html\\Attendance-System-Project-main\\6. Attendence\With_Camera" +
...
with st.container():
    c, l = st.columns(2)
    with c:
        start = st.button("Initiate Attendance")
    with l:
        stop = st.button("End Attendance")
...
df = pd.read_csv("D:\\p1 html\\Attendance-System-Project-main\\6. Attendence\\With_Camera" +
...
while start:
    ...
    if face_names:
        for face_loc, name in zip(face_locations, face_names):
            ...
            with open("Attendance-System-Project-main\\6. Attendence\With_Camera\\" + name_of_attendence_sheet+".csv", 'a') as csv_file:
